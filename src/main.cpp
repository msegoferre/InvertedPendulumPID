...
/** \mainpage RoboComp::InvertedPendulum
 *
 * \section intro_sec Introduction
 *
 * The InvertedPendulum component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/InvertedPendulum --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class InvertedPendulum : public RoboComp::Application
{
public:
	InvertedPendulum (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::InvertedPendulum::initialize()
{
...
int ::InvertedPendulum::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		imu_proxy = Ice::uncheckedCast<RoboCompIMU::IMUPrx>( communicator()->stringToProxy( proxy ) );
	}
	...
	tprx = std::make_tuple(imu_proxy,jointmotorsimple_proxy);
...
int main(int argc, char* argv[])
{
	...
	::InvertedPendulum app(prefix, startup_check_flag);
